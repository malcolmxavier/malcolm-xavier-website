...
export function TmdbAttribution() {
  ...
  // Renders as a bare <p>. Alignment and the gap above it belong to
  // FooterNotes, the footer slot that decides whether this note is on
  // the page at all — a wrapper here would only be a second opinion
  // about the same spacing. The note runs long, so it sets its own
  // line at narrow widths and wraps to two or three in the footer's
  // right-hand slot; that is reading rhythm rather than a layout
  // failure, and the ToS asks for the disclosure to be prominent, not
  // to be unbroken.
  return (
