...
// ─── Share + social glyphs ─────────────────────────────────────────
// Used by the ShareBar. Brand marks (X, Bluesky, WhatsApp, Facebook,
// Reddit) are the official simplified one-color glyphs (Simple Icons,
// CC0) and use fillIconProps. Messages (chat bubble) and the generic
// Share node glyph are Heroicons outline (MIT) and use strokeIconProps.

export function IconX({ size = 16, ...props }: IconProps) {
  return (
    <svg {...fillIconProps(size)} {...props}>
      {/* Official X (formerly Twitter) brand glyph */}
      <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" />
    </svg>
  );
}

export function IconBluesky({ size = 16, ...props }: IconProps) {
  return (
    <svg {...fillIconProps(size)} {...props}>
      {/* Official Bluesky butterfly glyph */}
...
export function IconFacebook({ size = 16, ...props }: IconProps) {
  return (
    <svg {...fillIconProps(size)} {...props}>
      {/* Official Facebook 'f' brand glyph */}
      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
    </svg>
  );
}

export function IconReddit({ size = 16, ...props }: IconProps) {
  return (
    <svg {...fillIconProps(size)} {...props}>
      {/* Official Reddit brand glyph */}
...
export function IconMessages({ size = 16, ...props }: IconProps) {
  return (
    <svg {...strokeIconProps(size)} {...props}>
      {/* Heroicons outline chat-bubble — the Messages / SMS channel */}
...
export function IconShare({ size = 16, ...props }: IconProps) {
  return (
    <svg {...strokeIconProps(size)} {...props}>
      {/* Heroicons outline share-nodes — the native / generic share glyph */}
